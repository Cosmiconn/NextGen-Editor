...
enum class ShnValueKind { UInt8, UInt16, UInt32, Int8, Int16, Int32, Float, String, PairUInt32, Raw };
...
struct ShnRow { std::uint16_t recordLength = 0; std::vector<ShnValue> values; };
struct ShnFile {
    std::uint32_t version = 0;
    std::uint32_t defaultRecordLength = 0;
    std::vector<std::uint8_t> cryptoHeader;
