...
// -----------------------------------------------------------------------------------------
// .aid ("Rou.aid", 60 Byte, vollständig geparst): Zonen-/Area-Metadaten.
//   int32   recordType   (in der Referenzdatei: 1)
//   char[32] name        (z.B. "MH_Zone1", nullterminiert/nullgepolstert)
//   int32   flag         (in der Referenzdatei: 1)
//   float[5] bounds       vermutlich Bounding-/Trigger-Volumen - exakte Bedeutung ungeklärt
// -----------------------------------------------------------------------------------------
