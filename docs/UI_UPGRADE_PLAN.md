...
- Skill-, Quest- und Custom NPC/Mob-Editor sowie Händler-/Shop-, NPC-Dialog- und Patrouillen-/MobRoam-Untereditor verwenden inzwischen durchgängig dieselbe DE/EN-Panel-Sprache. Auch der spezialisierte NPC-/Mob-/Portal-Szene-Outliner (Gruppen, Filter, Tooltips und Kontextaktionen) ist an die Sprachumschaltung angebunden; verbleibende tiefe Spezialoberflächen können schrittweise nachgezogen werden;
