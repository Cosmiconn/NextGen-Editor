...
- DE/EN-QA: Project Hub, Projekt-Konfiguration und Map Launcher enthalten keine fest verdrahteten deutschen sichtbaren UI-Texte mehr. Workspace-Karten, Pfad-Hilfen, Map-Erstellung, Rescan-/Fehlertexte und Recent-Tooltips folgen jetzt der globalen Sprachumschaltung.
