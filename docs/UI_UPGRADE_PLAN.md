...
- Skill-, Quest- und Custom NPC/Mob-Editor sowie Händler-/Shop-, NPC-Dialog- und Patrouillen-/MobRoam-Untereditor verwenden inzwischen durchgängig dieselbe DE/EN-Panel-Sprache. Auch der gesamte Szene-Outliner ist an die Sprachumschaltung angebunden: NPC-/Mob-/Portal-Gruppen, Filter, Tooltips und Kontextaktionen ebenso wie Objektgruppen, Labels, Eye/Lock und Auswahlaktionen; verbleibende tiefe Spezialoberflächen können schrittweise nachgezogen werden;
