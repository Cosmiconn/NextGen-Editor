...
- [x] Semantik-QA: `system.recent_projects` wird nur für echte Projekt-Historie verwendet; „zuletzt geöffnete Karten“ nutzen `file.open` statt das Projekticon umzudeuten.
