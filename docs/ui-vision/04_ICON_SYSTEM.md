...
Für den UI-Retrofit ist das vom Nutzer gelieferte Paket **`NextGen_Icons_True_Vector_Set_With_Sizes.zip`** die verbindliche Artwork-Quelle.
...
- Paket-Rastermaster haben Vorrang, wenn eine automatisch rekonstruierte SVG-Fassung visuell sichtbar schlechter ist
